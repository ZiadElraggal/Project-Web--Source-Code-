...
export const experiences = [
    {
        ...
        points: [
            "Conducted research and engineered a MATLAB script proficient in recording, visualizing, and logging temperatures from multiple data logging devices.",
            "Crafted comprehensive user manuals delineating operational procedures for the aforementioned data loggers, alongside an exhaustive guide elucidating the functionality and utilization of the developed script.",
            "Formulated meticulous procedures and compiled equipment lists essential for the seamless execution of experiments, meticulously ensuring adherence to standardized protocols and qualifications.",
            "Innovated and implemented bespoke solutions leveraging coding techniques to automate processes, thereby substantially diminishing the necessity for physical site visits to monitor experiment progression. This initiative yielded a notable reduction of approximately 43.8% in the associated operational costs.",
            "Supervised and managed long-term, large-scale experiments in the absence of direct supervision, diligently administering routine maintenance to both the experimental apparatus and the underlying code infrastructure to optimize operational efficiency."
        ],
    },
    {
